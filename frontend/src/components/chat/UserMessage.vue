    ...
    <div class="chat chat-end">
        ...
        <div class="chat-bubble bg-white border border-gray-400 text-black">
            ...
            <template v-else-if="message?.type === 'voice'">
                <audio class="ml-[-15px] mt-[-5px] md:m-0" controls  :src="message.body?.audioUrl" controlslist="nodownload noplaybackrate nomute"></audio>
                <p class="text-gray-700 pl-3"> &gt; {{ message.body.transcription }}</p>
            </template>
        </div>
